        ...
        <div>
            ...
            <div class="container col-xxl-8 px-4 py-5">
                <div class="row flex-lg-row-reverse align-items-center g-5 py-4">
                    ...
                    <div class="col-lg-6">
                        <h1 class="display-5 lh-2 mb-3" className="headline2">What is WCAG 2.1?</h1>
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                            <a href="https://www.w3.org/WAI/standards-guidelines/wcag/" target="_blank" type="button" class="btn btn-primary btn-lg px-4 me-md-2" >Read More</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="p-5 mb-4 rounded-3 white">
                <div class="container px-4 py-4" id="featured-3">
                    <h2 class="display-6 text-center fw-bold">Our Tech Stack</h2>
